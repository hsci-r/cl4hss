...
* Minimum requirement (grade 1/5): Your project must include a humanities/social science research question, and a description of a complete pipeline that utilises computation in at least one step to move from a dataset to answer that question. In addition, at least one computational step needs to be fully implemented.
